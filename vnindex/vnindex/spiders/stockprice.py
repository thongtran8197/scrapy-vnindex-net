...
class StockPriceSpider(scrapy.Spider):
    name = "stock_price"
    custom_settings = {
        "ITEM_PIPELINES": {"vnindex.pipelines.StockPriceSpiderPipeline": 1}
    }
    ...
    def start_requests(self):
        ...
        for key, ogan_codes in ogan_code_mapping.items():
            from_date = "2000-10-20"
            to_date = "2023-08-26"
            for ogan_code in ogan_codes:
                url = f'https://technical.fiintrade.vn/TradingView/GetStockChartData?language=vi&Code={ogan_code}&Frequency=Daily&From={from_date}&To={to_date}&Type=Stock'
                ...
                file_name = "price" + "_" + self.convert_vietnamese(key).replace(" ", "_").replace(",", "")
    ...
    def parse(self, response, **kwargs):
        ...
        for item in items:
            ...
            data_item = StockPriceItem(
                ...
                total_match_volume=item.get("totalMatchVolume"),
                file_name=file_name,
            )
            yield data_item
